...
namespace NSegmentDisplay {
    public class N14Segments : N7Segments {
        public N14Segments() : base() {
            ...
            base.Encodings.Clear(); //            NMLKJIHGFEDCBA
            base.Encodings.AddRange(new int[] { 0b00000000111111,    // 0
                                                0b00000100000110,    // 1
                                                0b00000011011011,    // 2
                                                0b00000010001111,    // 3
                                                0b00000011100110,    // 4
        ...
        public override void SetupSegments() {
            ...
            if(segments.Length == 14) {
                ...
                segments[7].Width = mWidth / 2 - mPadding;

                // G Redefinition
                segments[6].Width = mWidth / 2 - mPadding;
